...
// Adjuster Routes
$router->group(['prefix' => 'adjuster','middleware' => ['role:Adjuster']], function($router)
{
...
// Assessor Routes
$router->group(['prefix' => 'assessor','middleware' => ['role:Assessor']], function($router)
{
    //Motor  assessment User Module
...
$router->group(['prefix' => 'head-assessor','middleware' => ['role:Head Assessor']], function($router)
{

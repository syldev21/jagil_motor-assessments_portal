...
class SalvageRegister extends Model
{
    ...
    protected $fillable = ['vehicleRegNo','claimID','claimNo','buyerID','cost','logbookReceived','logbookDateReceived','recovered','recoveredBy','recordsReceived','documentsIssued','dateRecovered','location','createdBy','updatedBy',

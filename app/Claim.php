...
class Claim extends Model
{
    ...
    protected $fillable = ['claimNo','policyNo','branch','subClassCode','vehicleRegNo','carMakeCode','carModelCode','engineNumber','chassisNumber','yom','garageID','centerID','customerCode','claimType',
        'sumInsured','excess','intimationDate','loseDate','location','changed','salvageProcessed','salvageProcessedDate','salvageProcessedBy','LPOAmount','LPOAddedBy','LPODateCreated','createdBy','updatedBy','claimStatusID','active','inPremia','archivedBy','archivalNote','archivedAt','isSubrogate','companyID','thirdPartyDriver','thirdPartyPolicy','thirdPartyVehicleRegNo','dateModified','dateCreated'];

                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div id="printableArea">
                                    ...
                                    <div class="row">
                                        <div class="col s6">
                                            <h5>{{$assessor->firstName}} {{$assessor->lastNaem}}</h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12">
                                ...
                                <div class="modal-body clearfix">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col m4 s12">
                                            <a href="#" class="btn blue lighten-2 waves-effect" id="review-assistant-head-assessor-assessment">Submit</a>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col m4 s12">
                                            <a href="#" class="btn blue lighten-2 waves-effect" id="assistant-head-assessor-request-change">Submit</a>

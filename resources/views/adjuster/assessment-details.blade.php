                                ...
                                <div class="row">
                                    <div class="input-field col m6 s12">
                                        <input id="name" type="text" name="name"
                                               value="{{isset($assessment->assessor) ? $assessment->assessor->firstName : null}}" disabled>
                                        <label for="name" class="active">First Name</label>
                                    </div>
                                    <div class="input-field col m6 s12">
                                        <input id="lastName" type="text" name="lastName"
                                               value="{{isset($assessment->assessor) ? $assessment->assessor->lastName : null}}" disabled>
                                ...
                                <div class="row">
                                    <div class="input-field col m6 s12">
                                        <input id="MSISDN" type="text" name="MSISDN"
                                               value="{{isset($assessment->assessor) ? $assessment->assessor->MSISDN : null}}" disabled>
                                        <label for="MSISDN" class="active">Phone Number</label>
                                    </div>
                                    <div class="input-field col m6 s12">
                                        <input id="email" type="text" name="email" value="{{isset($assessment->assessor) ? $assessment->assessor->email : null}}"
                                               disabled>
                                        <label for="email" class="active">Email</label>
                                    </div>
                                </div>

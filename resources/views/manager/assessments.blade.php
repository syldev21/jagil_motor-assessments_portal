                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col m3 s12">
                                        <div class="input-field col s12">
                                            <button class="btn cyan waves-effect waves-light" type="submit" id="filter-manager-assessments"
                                                    name="action">
                                                            ...
                                                            @if($assessment['assessmentStatusID'] == \App\Conf\Config::$STATUSES['ASSESSMENT']['APPROVED']['id'])
                                                                ...
                                                                @if(isset($assessment['supplementaries']))
                                                                    @foreach($assessment['supplementaries'] as $supplementary )
                                                                        ...
                                                                        <li><a href="#!" id="view-manager-supplementary-report" data-id="{{$supplementary->id}} "><i

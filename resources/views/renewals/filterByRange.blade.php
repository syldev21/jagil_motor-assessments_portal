<input type="hidden" id="flag" value="fbyRange" name="period"/>
            ...
            <td colspan="16" style="font-size: 11px;">
                <table class="tbl-accordion-nested tb">
                        ...
                        <tr class="tbl-accordion-section" >
                            ...
                            <td colspan="13">
                                ...
                                <ul class="ul">
                                    ...
                                    <li style="width:100px;position:relative; left: 70px; ">{{$renewal->productDesc}}</li>
                                    ...
                                    <li style="width: 80px;position:relative;left:-20px;">{{\App\Renewal::where('policyNumber', $renewal->policyNumber)->whereDate('policyToDate','>=',$formattedFromDate )
                                        ->whereDate('policyToDate','<=',$formattedDate )->sum("renewalPremium")}}</li>
                    ...
                    <tbody class="bd">
                       ...
                       @foreach (\App\Renewal::where('policyNumber', $renewal->policyNumber)->whereDate('policyToDate','>=',$formattedFromDate )
                       ->whereDate('policyToDate','<=',$formattedDate )->get() as $subrenewal )

<input type="hidden" id="flag" value="fby" name="period"/>
<table id="data-table-simple" class="display">
        ...
        <tr class="prow">
            ...
            <th>
                <ul class="ul">
                    ...
                    <li style="position:relative;left: -10px;">Cover Type</li>
                    <li style="position:relative;left: -15px;" >Make</li>
                    <li >Model</li>
                    {{-- <li >RegNo.</li> --}}
                    {{-- <li>YOM</li> --}}
    ...
    <tbody >
        ...
        {{-- @foreach ($renewalChunk as $renewal) --}}
            ...
            <td colspan="16" style="font-size: 11px;">
                <table class="tbl-accordion-nested tb">
                        ...
                        <tr class="tbl-accordion-section" >
                            ...
                            <td colspan="13">
                                ...
                                <ul class="ul">
                                    ...
                                    <li style="width:80px; position:relative; left: 60px;word-break: break-all;">{{$renewal->policyNumber}}</li>
                                    <li style="width:100px;position:relative; left: 50px; ">{{$renewal->productDesc}}</li>
                                    <li style="width: 80px;position:relative; left: 40px;"> {{$renewal->coverType}}</li>
                                    <li style="width: 60px;position:relative;left: 20px; font-size:9px;word-break: break-all; ">{{$renewal->make}}</li>
                                    <li style="width: 60px;position:relative;left: 10px; font-size:9px; word-break: break-all;">{{$renewal->model}}</li>
                                    ...
                                    <li style="width: 80px;position:relative;left:-20px;">{{\App\Renewal::where(['policyNumber' => $renewal->policyNumber, 'policyToDate'=> $formattedDate ])->sum("renewalPremium")}}</li>
                                    <li style="width: 80px;position:relative;right:35px;">{{$renewal->lossRatio}}</li>
                                    ...
                                    <li class="test" style="width: 10px;position:relative; right: 20px;">
                                        ...
                                        @else<i class="material-icons"  data-id="{{$renewal->ID}}" style="color: red">clear</i>@endif
                                                ...
                                                <td><a class="waves-effect waves-light btn approveSubDetails">Approve</a></td>
                    ...
                    <tbody class="bd">
                        ...
                        @foreach (\App\Renewal::where(['policyNumber' => $renewal->policyNumber, 'policyToDate'=>

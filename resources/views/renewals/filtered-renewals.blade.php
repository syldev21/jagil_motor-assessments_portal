<input type="hidden" id="flag" value="frenewal" name="period"/>
        ...
        <tr class="prow">
            ...
            <th>
                <ul class="ul">
                    ...
                    <li>Cover Type</li>
                    <li style="position: relative;right:15px;" >Make</li>
                    <li >Model</li>
                    {{-- <li >RegNo.</li> --}}
                    {{-- <li>YOM</li> --}}
    ...
    <tbody>
        ...
        <tr style="align-content: center;">
            <td colspan="16" style="font-size: 11px;">
                <table class="tbl-accordion-nested tb">
                        ...
                        <tr class="tbl-accordion-section" style="z-index: -1;">
                            ...
                            <td colspan="13">
                                ...
                                <ul class="ul">
                                    ...
                                    <li style="width: 60px;position:relative;left: 10px; font-size:9px;word-break: break-all; ">{{$renewal->make}}</li>
                                    ...
                                    <li style="width: 80px;position:relative; position:relative; left: -15px;">{{\App\Renewal::where('policyNumber', $renewal->policyNumber)->whereDate('policyToDate','>=',$formattedFromDate)->whereDate('policyToDate','<=',$formattedDate )->sum("renewalPremium")}}</li>
                                    <li style="width: 80px;position:relative;right:45px; position:relative; left: -25px;">{{$renewal->lossRatio}}</li>
                    ...
                    <tbody class="bd">
                        ...
                        @foreach (\App\Renewal::where('policyNumber', $renewal->policyNumber)->whereDate('policyToDate','>=',$formattedFromDate )->whereDate('policyToDate','<=',$formattedDate  )->get() as $subrenewal )
            ...
            <td class="status"><input type="text" data-id="{{$subrenewal->ID}}" data-id2="{{$subrenewal->policyNumber}}" class="rp"
                    value="{{$subrenewal->renewalPremium}}" style="width: 80px; text-align: center;"></td>
...
<script>
    $(document).ready(function(e){
        ...
        $('.approveSubDetails').on('click', function(){
                ...
                // console.log($(this).parentsUntil('.test2'));

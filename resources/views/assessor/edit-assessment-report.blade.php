                                        ...
                                        <table class="centered">
                                            ...
                                            @else
                                                <tr class="dynamicVehiclePart">
                                                    ...
                                                    <td>
                                                        <input id="discount_0" oninput="getTotal(0);findTotal()" placeholder=""
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="step-actions">
                                                ...
                                                <input type="submit" class="waves-effect waves-dark btn next-step showActionButton actionButton"
                                                       value="SUBMIT" id="submit-edited-assessment" />
                                                <a href="#"
...
<script type="text/javascript">
    ...
    $("#dynamicPartsSelector").on('click','#addPart',function (){
        ...
        $('#addP').append('<tr class="row dynamicVehiclePart removable" id="row'+t+'">\n' +
            ...
            '                                                        </td>\n' +
            '                                                        <td>\n' +
            '                                                            <select id="vehiclePart_'+t+'" name="vehiclePart[]" class="browser-default validate" required>\n' +
